...
class Greatest_Actor extends Greatest_Picture 
{
    public void Actor()
    {
    Scanner in=new Scanner(System.in);
    ...
    for (int i = 0; i < numVoters; i++)
    {
        ...
        String vote1 = in.nextLine();
        if (actor.containsKey(vote1))
        {
            actor.put(vote1, actor.get(vote1) + 1);
            System.out.println("Thank you for your vote!");
        } 
        else
        {
...
class Greatest_Actress extends Greatest_Actor 
{
    public void Actress()
    {
    Scanner in=new Scanner(System.in);
...
class Greatest_Director extends Greatest_Actress
{
...
class Original_Screenplay extends Greatest_Director
{
...
class Adapted_Screenplay extends Original_Screenplay
{
...
class Visual_Effects extends Adapted_Screenplay
{
    public void Vfx()
    {
    Scanner in=new Scanner(System.in);
...
class Cinematography extends Visual_Effects
{
...
class Film_Editing extends Cinematography
{
    public void Editing()
    {
    Scanner in=new Scanner(System.in);
...
class Awards extends Film_Editing
{
    public void awards()
    {
        System.out.println("\n\n");
...
public class Awards_Show extends Awards
{
    public static void main(String[] args) 
    {   
        try
        {
            Awards_Show aw=new Awards_Show();
